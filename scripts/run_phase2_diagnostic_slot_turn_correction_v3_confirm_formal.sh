...
echo "[phase2c_slot_turn_v3_confirm] running standalone diagnostic held-out compare"
...
echo "[phase2c_slot_turn_v3_confirm] running forecast integration compare"
...
echo "[phase2c_slot_turn_v3_confirm] completed"
